...
/**
 * @type {{tokenContract, upfiringContract, uprStakingContract, ufrTokenContract, uprSwapContract , providerUrl, etherscanUrl}}
 */
...
export const UPRSTAKING = config.uprStakingContract;
export const UFRTOKEN = config.ufrTokenContract;
export const UPRSWAP = config.uprSwapContract;
