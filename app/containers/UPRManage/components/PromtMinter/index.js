...
class PromtMinter extends PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      address: '',
  ...
  handlerResult = () => {
    ...
    const { password, address, gasPrice, gasLimit } = this.state;
  ...
  render() {
    ...
    return (
      <PopUp>
        ...
        <PopUpMintTitle>Add Minter</PopUpMintTitle>
        <PopUpSubTitle>Enter the address to be minter.</PopUpSubTitle>
        <RowCenter>
          <InputWrapper>
            <UInput
              value={address}
              ...
              type="text"
              name="input"
              error={!valid ? 'Please enter the correct address' : null}
              centerContent
            />
          </InputWrapper>
        </RowCenter>
