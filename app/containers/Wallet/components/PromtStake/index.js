...
class PromtStake extends PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      value: '',
  ...
  render() {
    ...
    return (
      <PopUp>
        ...
        <PopUpBurnTitle>Stake UPR</PopUpBurnTitle>
        <PopUpSubTitle>Enter the amount of UPR to Stake.</PopUpSubTitle>
        <RowCenter>
          <InputWrapper>
            <UInput
              value={value}
