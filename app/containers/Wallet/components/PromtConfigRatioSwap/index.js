...
class PromtConfigRatioSwap extends PureComponent {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    ...
    return (
      <PopUp>
        ...
        <PopUpBurnTitle>Configure ratio</PopUpBurnTitle>
        <PopUpSubTitle>Enter the value of UFR swapping to UPR.</PopUpSubTitle>
        <RowCenter>
          <InputWrapper>
            <UInput
              value={value}
...
export default PromtConfigRatioSwap;
