...
export class PromptETHReplenish extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      value: '',
  ...
  handlerInputText = e => {
    this.setState({ valid: e.target.validity.valid, value: e.target.value });
  };
        ...
        <RowCenter>
          <InputWrapper>
            <UInput
              ...
              label={trans('Prompt.value.AmountETH')}
              type="text"
              name="input"
