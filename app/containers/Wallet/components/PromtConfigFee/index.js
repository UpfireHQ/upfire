...
class PromtConfigFee extends PureComponent {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    ...
    return (
      <PopUp>
        ...
        <PopUpBurnTitle>Configure fee</PopUpBurnTitle>
        <PopUpSubTitle>Enter the percentage of fee.</PopUpSubTitle>
        <RowCenter>
          <InputWrapper>
            <UInput
              value={value}
