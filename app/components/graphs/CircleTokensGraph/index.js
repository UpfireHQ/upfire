  ...
  get additionalConfig() {
    ...
    return Number(totalSpending) === 0 && Number(totalReceiving) === 0
      ...
      : {
          ...
          colors: [colors.borderBlue3, colors.buttonBackgroundClolor],
          titleField: 'title',
          colorField: 'color',
          balloon: {
            fixedPosition: false,
          ...
          balloonText:
            "<div><div style='color:[[color]];padding-bottom: 5px;'>[[title]]</div><div>[[value]] UFR</div></div>"
        };
  }
  ...
  get summary() {
    ...
    return (
      <SumWrapper>
        ...
        <SumDescription>{trans('popups.upload.ETH')}</SumDescription>
      </SumWrapper>
    );
  }
