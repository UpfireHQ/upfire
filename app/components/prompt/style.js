...
export const PopUpMinterTitle = styled(PopUpTitle)`
  margin: 0;
`;

export const PopUpBurnTitle = styled(PopUpTitle)`
  margin: 0;
`;

export const PopUpMintTitle = styled(PopUpTitle)`
  margin: 0;
`;
...
export const PopUpSwapTo = styled.h3`
  margin: 0;
