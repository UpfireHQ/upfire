  ...
  > div {
    ...
    &.right {
      ...
      &::after {
        ...
        border-width: 5px;
        border-style: solid;
        border-color: transparent ${colors.tooltipsBackground} transparent
          transparent;
      }
    }
  }
  ...
  render() {
    ...
    return (
      <Button onClick={onClick} disabled={disabled} style={style}>
        { !!imageIcon ? <img src={imageIcon} /> : <span className={iconClass} /> }
        {text ? <div className={positionClass}>{text}</div> : null}
      </Button>
    );
  }
}
