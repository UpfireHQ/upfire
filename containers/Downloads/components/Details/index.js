...
export default class Details extends Component {
  ...
  get SpeedTab() {
    ...
    const timeElapsed =
      !clientTorrent.timeRemaining || clientTorrent.timeRemaining === Infinity
        ? null
        : clientTorrent.timeRemaining;

    const timeRemaining =
      isFinite(clientTorrent.timeRemaining) && clientTorrent.timeRemaining;
    return (
      <Column>
        <Row>
          <FullFlex>
            <ThirdFlex>
              ...
              <HalfFlexDetail>
                <p>{(timeElapsed && convertMS(timeElapsed)) || '--'}</p>
              </HalfFlexDetail>
              <SpeedColumnFlex>
            ...
            <ThirdFlex>
              ...
              <HalfFlexDetail>
                <p>{(timeRemaining && convertMS(timeRemaining)) || '--'}</p>
              </HalfFlexDetail>
              <SpeedColumnFlex>
